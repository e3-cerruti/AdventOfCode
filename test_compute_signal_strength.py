...
class TestComputeSignalStrength(TestCase):
    ...
    def test_43210(self):
        signal = compute_signal_strength([4, 3, 2, 1, 0], 'amp_test_43210.dat')
    ...
    def test_01234(self):
        signal = compute_signal_strength([0, 1, 2, 3, 4], 'amp_test_01234.dat')
    ...
    def test_65210(self):
        signal = compute_signal_strength([1, 0, 4, 3, 2], 'amp_test_65210.dat')
